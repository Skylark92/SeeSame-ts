...
import { DocumentReference, doc, getDoc, increment, runTransaction } from 'firebase/firestore';

export default async function likeComment(surveyId: string, commentId: string, user: UserData) {
